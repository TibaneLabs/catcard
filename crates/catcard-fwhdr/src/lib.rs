...
pub const APPROVED_PUBKEYS: [[u8; 64]; NUM_PUBKEYS as usize] = [
    ...
    [
        0xd6, 0xa2, 0xc8, 0x1d, 0x1c, 0x81, 0x5e, 0xdf, 0xa6, 0x0c, 0x29, 0x6d, 0xb8, 0x57, 0x8f, 0x8d,
        0x5e, 0x29, 0x69, 0x92, 0xce, 0xd1, 0x78, 0xc1, 0x7b, 0x20, 0xd7, 0x31, 0x7b, 0xa1, 0x96, 0xb5,
        0x3d, 0xef, 0x1b, 0x0c, 0xaa, 0x79, 0x1a, 0xc3, 0x45, 0x58, 0xc4, 0xc8, 0x8a, 0x2d, 0xeb, 0xff,
        0xfe, 0x9b, 0x82, 0x01, 0x87, 0x5f, 0x5e, 0xbc, 0x96, 0xa5, 0xe5, 0x4f, 0xc7, 0x68, 0xfe, 0x9f,
    ],
    // [2] Coinkite production (reserved for future use)
    [
        0x42, 0xef, 0x66, 0x01, 0x56, 0xc4, 0xcf, 0x95, 0xf4, 0xb5, 0xf0, 0x38, 0x64, 0x11, 0x26, 0xc5,
        0x99, 0x39, 0xc1, 0x66, 0x32, 0x06, 0x12, 0x14, 0x4c, 0x25, 0x9c, 0x68, 0x35, 0x8c, 0xd3, 0xba,
        0x24, 0x78, 0xde, 0x8c, 0x52, 0xab, 0xdf, 0x6c, 0xb8, 0xbf, 0x09, 0x78, 0x03, 0xbb, 0x63, 0x3a,
        0x11, 0x01, 0xd9, 0x0e, 0xa4, 0x7a, 0x73, 0x8f, 0xbf, 0x18, 0x3b, 0x7f, 0xf0, 0x0a, 0x7b, 0xc8,
    ],
    // [3] Coinkite production (reserved for future use)
    [
        0x67, 0x60, 0x54, 0x56, 0x82, 0x0c, 0xec, 0xc5, 0x1d, 0xbc, 0x82, 0x08, 0x16, 0xc1, 0x39, 0xef,
        0xf5, 0xbf, 0xba, 0x32, 0x7c, 0xce, 0x5f, 0xe3, 0x74, 0x1e, 0x62, 0xd7, 0xe9, 0xfc, 0xc5, 0x4c,
        0x8a, 0xe8, 0x11, 0x8d, 0xc3, 0xad, 0xc2, 0x13, 0x92, 0x29, 0x4f, 0x2a, 0xea, 0xd2, 0xf8, 0xa4,
        0xc4, 0xd5, 0x7c, 0xfe, 0x12, 0x05, 0x45, 0x3b, 0x54, 0x89, 0x59, 0x07, 0xda, 0xd6, 0xd7, 0x88,
    ],
    // [4] Coinkite production (reserved for future use)
    [
        0x43, 0xb1, 0xcf, 0x37, 0xd2, 0x7c, 0x89, 0x1f, 0x5b, 0xfe, 0xac, 0xf3, 0xba, 0x33, 0xfc, 0x95,
        0x81, 0xd9, 0xe7, 0xdd, 0x25, 0x95, 0xef, 0x14, 0xdd, 0xef, 0x97, 0xbb, 0x33, 0xf3, 0xd8, 0xa7,
        0x34, 0x2b, 0x7a, 0x97, 0xba, 0xb3, 0xaa, 0x73, 0xe7, 0x9d, 0x41, 0x32, 0xd8, 0xfc, 0xa1, 0x17,
        0x66, 0xb5, 0x0b, 0xfe, 0x63, 0x40, 0x21, 0x89, 0xc9, 0x92, 0x7b, 0x8e, 0x72, 0xdf, 0x0b, 0x59,
    ],
    // [5] Coinkite production (reserved) -- enabled on mk4/mk5/Q1, disabled on mk3
    [
        0xd0, 0x5c, 0xdc, 0x76, 0x16, 0x30, 0xdd, 0x30, 0xc2, 0x80, 0xf1, 0x56, 0x26, 0x5c, 0xa8, 0x61,
        0xd7, 0x4f, 0x69, 0x69, 0xe5, 0xb8, 0x57, 0x3d, 0x35, 0xe2, 0x2a, 0x58, 0xdd, 0xce, 0x9a, 0xc6,
        0x45, 0xa9, 0x1c, 0x2b, 0x0c, 0x01, 0xfc, 0x8e, 0xbf, 0x3f, 0x51, 0x13, 0x80, 0x7e, 0x7c, 0x13,
        0xd5, 0x4f, 0x4b, 0x5e, 0x9b, 0x4c, 0x9b, 0xd5, 0x9e, 0x1d, 0xd8, 0xe0, 0xad, 0xc0, 0x46, 0x22,
    ],
];
    ...
    fn approved_pubkeys_table_is_well_formed() {
        ...
        for i in 0..APPROVED_PUBKEYS.len() {
            for j in (i + 1)..APPROVED_PUBKEYS.len() {
                assert_ne!(APPROVED_PUBKEYS[i], APPROVED_PUBKEYS[j], "slots {i} and {j}");
            }
        }
