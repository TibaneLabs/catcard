...
1. **Wallet export as output descriptors** (BIP-380) to SD -- the only way to get a
   watch-only wallet set up on a computer, which is what creates the PSBTs to sign.
